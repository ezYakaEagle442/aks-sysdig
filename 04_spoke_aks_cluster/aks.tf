...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  default_node_pool {
    ...
    vm_size                      = "Standard_D8s_v5" # "Standard_D4s_v5" "Standard_D2s_v5"  "Standard_D2pds_v5" # "Standard_D2ds_v5" # "standard_d2pds_v5"
  ...
  network_profile {
    ...
    network_policy    = "azure"               # "azure" "calico"
  ...
  maintenance_window_auto_upgrade {
    ...
    interval     = 1
    duration     = 9
    day_of_week  = "Wednesday" # Monday, Tuesday, Wednesday, Thurday, Friday, Saturday and Sunday
    day_of_month = null
    start_time   = "02:00"
    utc_offset   = "+01:00"
  ...
  maintenance_window_node_os {
    ...
    interval     = 1
    duration     = 9
    day_of_week  = "Wednesday" # Tuesday, Wednesday, Thurday, Friday, Saturday and Sunday
    day_of_month = null
    start_time   = "02:00"
    utc_offset   = "+01:00"
    start_date   = "2023-07-26T00:00:00Z"
