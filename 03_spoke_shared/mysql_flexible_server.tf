...
resource "azurerm_mysql_flexible_server" "mysql_flexible_server" {
  ...
  administrator_login    = "mys_adm"
  # https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret.html
  administrator_password = var.mysql_password # should refer to a KV secret data.azurerm_key_vault_secret.example.value
